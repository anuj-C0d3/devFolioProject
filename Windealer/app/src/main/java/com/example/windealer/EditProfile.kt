...
import com.example.windealer.databinding.ActivityEditProfileBinding
...
class EditProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.savebtn.setOnClickListener {
            ...
            currentUser?.let {
                FirebaseDatabase.getInstance().reference.child("dealerprofiles").child(it.uid).child("dealer_data").setValue(profile)
